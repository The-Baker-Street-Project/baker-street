...
- `bakerst-brain-secrets` — ANTHROPIC_API_KEY, DEFAULT_MODEL, VOYAGE_API_KEY, AUTH_TOKEN, AGENT_NAME
- `bakerst-worker-secrets` — ANTHROPIC_API_KEY, DEFAULT_MODEL, AGENT_NAME
